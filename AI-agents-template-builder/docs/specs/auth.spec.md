...
|---|---|---|---|
| GET | /api/v1/auth | Yes | List items |
| POST | /api/v1/auth | Yes | Create item |
| GET | /api/v1/auth/:id | Yes | Get single item |
| PUT | /api/v1/auth/:id | Yes | Update item |
| DELETE | /api/v1/auth/:id | Yes | Soft delete item |
