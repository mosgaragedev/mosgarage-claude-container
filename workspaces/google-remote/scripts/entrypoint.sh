#!/bin/bash
# =============================================================================
# Mosgarage Docker - Entrypoint Script
# =============================================================================
...
mkdir -p ~/.vnc
echo "${VNC_PASSWORD:-mosgarage}" | vncpasswd -f > ~/.vnc/passwd
...
# Start XFCE4 desktop
# mosgarage is auto-launched by supervisor after desktop is ready
exec startxfce4
EOF
...
mkdir -p ~/workspace ~/.config ~/.mosgarage
...
# =============================================================================
# Check for mosgarage updates (if enabled)
# =============================================================================
if [ "${mosgarage_AUTO_UPDATE}" = "true" ]; then
    echo "Checking for mosgarage updates..."
    /opt/scripts/update-mosgarage.sh || true
fi
